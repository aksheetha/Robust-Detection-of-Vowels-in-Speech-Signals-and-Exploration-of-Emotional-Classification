...
Signal=audioread('E:\speech\code_13_02_19\input\SA1.WAV');
signl=Signal(1:20000);
%soundsc(signl)
nse=audioread('E:\speech\code_13_02_19\NoiseX_92\white.wav');
%I1=decimate(nse,4);
noise=nse(1:20000);
soundsc(noise)
...
subplot(3,1,1);	
plot(signl(1:20000),256,224,1024,fs,'yaxis')
...
subplot(3,1,2);	
plot(s3(1:20000),256,224,1024,fs,'yaxis')
...
subplot(3,1,3);
plot(500*M11(1:20000),256,224,1024,fs,'yaxis')
