...
%addpath(genpath('E:\speech\.Trash-1000\files\MSS_Estimators'));
%clean_file_path='E:/speech enhancement/code_13_02_19/input/in.txt';
clean_file_path='E:\speech\.Trash-1000\files\MSS_Estimators\data\path_1.txt';
clean_file_path_1=textread(clean_file_path,'%s');
%noisy_file_path='E:\speech enhancement\code_13_02_19\composite\out_path.txt';
%noisy_file_path1=textread(noisy_file_path,'%s');
noise_file_path='E:\speech\code_13_02_19\NoiseX_92\noise_p.txt';
noise_file_path1=textread(noise_file_path,'%s');
 
for j=1:10 %size(noise_file_path);
    j
...
for i=1:10 %size(clean_file_path)
    i
    cleanFile=char(clean_file_path_1(i,:));
    
    enhancedFile=char(noise_file_path1(i,:));
...
[Csig,Cbak,Covl,llr_mean,segSNR1,wss_dist,pesq_mos]= composite(cleanFile,'enhanced_map.wav');
llr_mean1=llr_mean1+llr_mean;
segSNR1=segSNR1+segSNR1;
