...
for j=3:3
    ...
    speech_noise=addnoise(speech_clean,Noise,10);
     wavwrite(speech_clean,fs,'clean2.wav');
    wavwrite(noisy_data,fs,'noisy2.wav');
    
     x = kalu('clean2.wav','noisy2.wav');
     
     
            wavwrite(x,fs,'enhanced2.wav');
figure();
...
%     
    ...
    [Csig,Cbak,Covl,llr_mean,segSNR,wss_dist,pesq_mos]= composite('clean2.wav','enhanced2.wav');
