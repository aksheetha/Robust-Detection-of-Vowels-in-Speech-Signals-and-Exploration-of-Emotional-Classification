...
for j=3:3
    ...
    wavwrite(speech_clean,fs,'clean_3.wav');
    wavwrite(noisy_data,fs,'noise_3.wav');
    
     x = ics('noise_3.wav','clean_3.wav','enhanced_3.wav',10,0);
     
     
            wavwrite(x,fs,'enhanced_3.wav');
             figure();
    ...
    [Csig,Cbak,Covl,llr_mean,segSNR,wss_dist,pesq_mos]= composite('clean_3.wav','enhanced_3.wav');
