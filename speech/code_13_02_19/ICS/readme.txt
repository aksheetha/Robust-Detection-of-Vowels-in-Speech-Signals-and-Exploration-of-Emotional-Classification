Present folder contains implementations of ideal channel selection (ICS) algorithms based on different selection criteria (as presented at CIAP'11 conference). For the SNR selection criterion, ICS is also known in the literature as ideal binary mask (see review in book by Wang and Brown, 2006, Wiley/IEEE Press). References for the other selection criteria are provided at the end of this file, and are available from our website.
